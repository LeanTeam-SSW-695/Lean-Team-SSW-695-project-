...
class TestAPP(unittest.TestCase):
    ...
    def test_coordinates(self):
        ...
        self.assertEqual(GoogleMapAPI.read_address(address1), {'lat': 42.338842, 'lng': -71.15455279999999})
        self.assertEqual(GoogleMapAPI.read_address(address2), {'lat': 40.748558, 'lng': -73.9857578})
    ...
    def test_distance(self):
        ...
        self.assertEqual(GoogleMapAPI.distance(x_coordinates, y_coordinates), ('211 mi', '3 hours 31 mins'))
